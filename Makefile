...
build-linux-386: ## build binary file linux-386
	...
	@GOOS=linux GOARCH=386 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/linux/releaser-linux-386 ./main.go
...
build-linux-amd64: ## build binary file linux-amd64
	...
	@GOOS=linux GOARCH=amd64 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/linux/releaser-linux-amd64 ./main.go
...
build-linux-arm: ## build binary file linux-arm
	...
	@GOOS=linux GOARCH=arm \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/linux/releaser-linux-arm ./main.go
...
build-linux-arm64: ## build binary file linux-arm64
	...
	@GOOS=linux GOARCH=arm64 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/linux/releaser-linux-arm64 ./main.go
...
build-windows-386: ## build binary file windows-386
	...
	@GOOS=windows GOARCH=386 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/windows/releaser-windows-386.exe ./main.go
...
build-windows-amd64: ## build binary file windows-amd64
	...
	@GOOS=windows GOARCH=amd64 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/windows/releaser-windows-amd64.exe ./main.go
...
build-windows-arm: ## build binary file windows-arm
	...
	@GOOS=windows GOARCH=arm \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/windows/releaser-windows-arm ./main.go
...
build-darwin-amd64: ## build binary file darwin-amd64
	...
	@GOOS=darwin GOARCH=amd64 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/darwin/releaser-darwin-amd64 ./main.go
...
build-darwin-arm64: ## build binary file darwin-arm64
	...
	@GOOS=darwin GOARCH=arm64 \
		...
		-installsuffix cgo \
		-trimpath \
		-o bin/darwin/releaser-darwin-arm64 ./main.go